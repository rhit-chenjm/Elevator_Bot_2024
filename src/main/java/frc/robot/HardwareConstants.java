...
public class HardwareConstants {
    ...
    public class CanIDs {
        ...
        public static int INTAKE_ROLLER = 21;

        // |====================== SHOOTER SUBSYSTEM CAN IDs ======================|
        public static int SHOOTER_PIVOT = 30;
        public static int LEFT_FLYWHEEL_MOTOR_ID = 31;
        public static int RIGHT_FLYWHEEL_MOTOR_ID = 32;
        public static int SHOOTER_FEEDER_ROLLER = 33;

        // |====================== TRAMP SUBSYSTEM CAN IDs ======================|
        public static int TRAMP_ROLLER = 40;

        //|====================== CLIMBER SUBSYSTEM CAN IDs ======================|
        public static int FRONT_CLIMBER_MOTOR = 50;
        public static int BACK_CLIMBER_MOTOR = 51;
    ...
    public class DIOPorts {
        ...
        public static int SHOOTER_PIVOT_ENCODER = 7; // These must be configured when robot is wired. 
    }

        public class ComponentTransformations { //Adjust with testing
    ...
    // TODO These are not correct values. Adjust for correct 
} 
}
